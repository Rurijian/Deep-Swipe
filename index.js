...
const DEFAULT_IMPERSONATION_PROMPT = 'NEW DIRECTION: Impersonate your next reply as if you were {{user}}, using this subsequent text as a guide to the reply\'s content: {{input}}';
